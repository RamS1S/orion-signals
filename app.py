...
<svg class="orion-svg" viewBox="0 0 1440 900" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="1060" y="630" fill="rgba(167,139,250,0.2)" font-size="9"
...
with tab_up:
    ...
    st.markdown('<div class="phone-note">Used for account verification and Telegram alerts</div>', unsafe_allow_html=True)
    ...
    if st.button("Create Account →", key="signup_btn"):
        if not all([su_username, su_name, su_email, su_phone, su_pass, su_confirm]):
            ...
            st.info("ℹ️ Registration coming soon. Stay tuned.")
