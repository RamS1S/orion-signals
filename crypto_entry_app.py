"""
Orion Signals — Crypto Entry Dashboard
₿ Crypto Entry €39/μήνα
"""
import streamlit as st

def show_crypto_entry_dashboard(user):
    st.markdown("""
    <style>
    ...
    .plan-badge{background:rgba(251,191,36,0.15);color:#FBB924;
        border:1px solid rgba(251,191,36,0.3);padding:0.25rem 0.75rem;
    ...
    <div class="orion-header">
        ...
        <span class="plan-badge">₿ Crypto Entry</span>
    </div>
    """, unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        <div style="background:rgba(124,58,237,0.1);border:1px solid rgba(124,58,237,0.2);
            ...
            <strong>🚀 Upgrade to Crypto Pro €89</strong><br>
            <span style="color:rgba(255,255,255,0.5);font-size:0.75rem;">
            ATR/SL/Target · Fuel Gauge · Fear & Greed · Funding Rate · Real-time alerts
            </span>
    ...
    <div class="coming-card">
        ...
        <div style="font-family:'Syne',sans-serif;font-size:1.8rem;font-weight:800;color:#fff;margin-bottom:0.5rem;">
            Crypto Entry Dashboard
        </div>
        <div style="color:rgba(255,255,255,0.5);font-size:0.9rem;max-width:400px;margin:0 auto;line-height:1.7;">
            Scanner for BTC, ETH and top altcoins.<br>
            RSI · MACD · MA · Bollinger · ADX · Volume<br>
            Momentum analysis · Backtesting · Portfolio tracker
        </div>
        <div style="margin-top:2rem;background:rgba(251,191,36,0.1);border:1px solid rgba(251,191,36,0.2);
                    border-radius:10px;padding:0.75rem 1.5rem;display:inline-block;">
            <span style="color:#FBB924;font-size:0.85rem;font-weight:600;">
